...
// Global 404 for paths that never reach a locale segment. The pass-through root
// layout renders no document shell, so this page provides its own <html>/<body>.
// Localized 404s (inside the app chrome) live in app/[locale]/not-found.tsx.
