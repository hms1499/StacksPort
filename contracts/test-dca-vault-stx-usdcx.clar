;; test-dca-vault-stx-usdcx: Test-only copy of dca-vault-stx-usdcx for simnet
;; Identical logic to dca-vault-stx-usdcx.clar; MPPU raised and TREASURY = deployer
