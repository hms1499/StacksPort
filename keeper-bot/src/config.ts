...
export async function loadConfig(): Promise<BotConfig> {
  ...
  return {
    ...
    contractName:     optional("CONTRACT_NAME", "dca-vault-sbtc-v2"),
    swapRouter:       optional("SWAP_ROUTER", "SP2CMK69QNY60HBG8BJ4X5TD7XX2ZT4XB62V13SV.bitflow-usdcx-swap-router"),
