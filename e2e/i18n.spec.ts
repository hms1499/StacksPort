...
test.describe("i18n", () => {
  ...
  test("Portuguese route renders with lang=pt", async ({ page }) => {
    await page.goto("/pt/dashboard");
    await expect(page.locator("html")).toHaveAttribute("lang", "pt");
  });

  test("Portuguese nav shows translated label", async ({ page }) => {
    await page.goto("/pt/dashboard");
    await expect(
