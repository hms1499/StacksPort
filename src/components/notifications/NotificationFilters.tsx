...
export default function NotificationFilters({
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-64 border-r border-gray-100 bg-white overflow-y-auto">
        {content}
      </aside>
      ...
      {isMobileOpen && (
        <>
          ...
          <aside
            className={cn(
              'fixed inset-y-0 left-0 z-50 w-72 bg-white shadow-xl overflow-y-auto lg:hidden',
