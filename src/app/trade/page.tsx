    ...
    <div className="flex flex-col min-h-screen">
      ...
      <AnimatedPage className="flex-1 p-4 md:p-6 max-w-2xl mx-auto w-full">
        <StaggerChildren className="space-y-4 md:space-y-5">
          ...
          <MotionCard className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          {/* Swap Tips */}
          <MotionCard className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
